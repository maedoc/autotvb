# Goal: Simulate with the Jansen and Rit model.
...
3. Instantiate the neural-mass model(s): `models.JansenRit`.
4. Define coupling function: `coupling.SigmoidalJansenRit`.
