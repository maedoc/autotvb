...
3. Instantiate the neural-mass model(s): `models.ReducedWongWang`, `models.Kuramoto`.
4. Define coupling function: `coupling.Kuramoto`, `coupling.Linear`.
