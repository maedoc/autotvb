# Goal: Simulation with the reduced Wong-Wang model
...
3. Instantiate the neural-mass model(s): `models.ReducedWongWang`.
4. Define coupling function: `coupling.Linear`.
6. Choose integrator: `integrators.EulerStochastic`.
